...
automobil::automobil(std::string modelo, std::string color, int cilindros, int millaje,
                     std::string tipo_de_transmision, std::string tipo_de_combustible, float precio) {
    this->modelo = modelo;
    this->color = color;
